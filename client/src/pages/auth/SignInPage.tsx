...
const inputSx = {
  ...
  '& .MuiOutlinedInput-root': {
    bgcolor: '#fff',
    borderRadius: 2,
    '& fieldset': { borderColor: '#bbb', borderRadius: 2 },
...
export default function SignInPage() {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ flexShrink: 0, pt: 5, px: 6, pb: 2 }}>
        <Box
          component="form"
        ...
        >
          <Box>
            ...
            <TextField value={username} onChange={e => setUsername(e.target.value)}
              required autoFocus autoComplete="username" sx={inputSx} />
          </Box>
          ...
          <Box>
            ...
            <TextField type="password" value={password} onChange={e => setPassword(e.target.value)}
              required autoComplete="current-password" sx={inputSx} />
          </Box>

          {error && (
            <Alert severity="error" sx={{ py: 0.25, fontSize: '0.82rem', borderRadius: 2 }}>
              {error}
            </Alert>
          )}
